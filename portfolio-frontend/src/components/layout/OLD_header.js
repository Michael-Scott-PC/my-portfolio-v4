...
const Header = ({ siteTitle }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`${headerStyles.welcomeContainer} text-center`}>
        <h2 className={headerStyles.myName}>
          Hi, I'm {data.strapiProfile.name}.
        </h2>
        <h5 className={headerStyles.welcome}>Welcome to my</h5>
        <h2 className={headerStyles.portfolio}>portfolio</h2>
      </div>
    </BackgroundImage>
  );
};
